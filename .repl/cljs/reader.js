...
cljs.reader.read_char = (function read_char(reader){if((function (){var and__2954__auto__ = reader;if(and__2954__auto__)
...
{var x__3558__auto__ = (((reader == null))?null:reader);return (function (){var or__2963__auto__ = (cljs.reader.read_char[goog.typeOf(x__3558__auto__)]);if(or__2963__auto__)
{return or__2963__auto__;
} else
{var or__2963__auto____$1 = (cljs.reader.read_char["_"]);if(or__2963__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__2954__auto__ = reader;if(and__2954__auto__)
...
{var x__3558__auto__ = (((reader == null))?null:reader);return (function (){var or__2963__auto__ = (cljs.reader.unread[goog.typeOf(x__3558__auto__)]);if(or__2963__auto__)
{return or__2963__auto__;
} else
{var or__2963__auto____$1 = (cljs.reader.unread["_"]);if(or__2963__auto____$1)
{return or__2963__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__3499__auto__,writer__3500__auto__,opt__3501__auto__){return cljs.core._write.call(null,writer__3500__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__2963__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__2963__auto__))
{return or__2963__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__11683){
var rdr = cljs.core.first(arglist__11683);
var msg = cljs.core.rest(arglist__11683);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__2954__auto__ = !((ch === "#"));if(and__2954__auto__)
{var and__2954__auto____$1 = !((ch === "'"));if(and__2954__auto____$1)
{var and__2954__auto____$2 = !((ch === ":"));if(and__2954__auto____$2)
...
{{
var G__11684 = (function (){sb.append(ch);
return sb;
})();
var G__11685 = cljs.reader.read_char.call(null,rdr);
sb = G__11684;
ch = G__11685;
continue;
}
...
{{
var G__11686 = cljs.reader.read_char.call(null,rdr);
ch = G__11686;
continue;
}
} else
...
var G__11687 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__11687;
continue;
}
} else
...
var G__11688 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__11688;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__2963__auto__ = (ch == null);if(or__2963__auto__)
{return or__2963__auto__;
} else
{var or__2963__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__2963__auto____$1)
{return or__2963__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__2963__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__2963__auto__))
{return or__2963__auto__;
} else
...
{{
var G__11689 = (function (){buffer.append(ch);
return buffer;
})();
var G__11690 = cljs.reader.read_char.call(null,reader);
buffer = G__11689;
ch = G__11690;
continue;
}
...
{if(("\\" === ch))
{{
var G__11691 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
...
{{
var G__11693 = (function (){buffer.append(ch);
return buffer;
})();
var G__11694 = cljs.reader.read_char.call(null,reader);
buffer = G__11693;
ch = G__11694;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__11696 = o;if(G__11696)
{var bit__3574__auto__ = (G__11696.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__3574__auto__) || (G__11696.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__11696.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IWithMeta,G__11696);
} else
{return false;
}
}
...
{{
var G__11701 = cljs.reader.read_comment.call(null,reader,ch);
var G__11702 = eof_is_error;
var G__11703 = sentinel;
var G__11704 = is_recursive;
reader = G__11701;
eof_is_error = G__11702;
sentinel = G__11703;
is_recursive = G__11704;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__11705 = reader;
var G__11706 = eof_is_error;
var G__11707 = sentinel;
var G__11708 = is_recursive;
reader = G__11705;
eof_is_error = G__11706;
sentinel = G__11707;
is_recursive = G__11708;
continue;
}
} else
{return res;
...
cljs.reader.leap_year_QMARK_ = (function leap_year_QMARK_(year){var and__2954__auto__ = cljs.reader.divisible_QMARK_.call(null,year,4);if(cljs.core.truth_(and__2954__auto__))
{var or__2963__auto__ = cljs.reader.indivisible_QMARK_.call(null,year,100);if(cljs.core.truth_(or__2963__auto__))
{return or__2963__auto__;
} else
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__11711 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__11711,0,null);var years = cljs.core.nth.call(null,vec__11711,1,null);var months = cljs.core.nth.call(null,vec__11711,2,null);var days = cljs.core.nth.call(null,vec__11711,3,null);var hours = cljs.core.nth.call(null,vec__11711,4,null);var minutes = cljs.core.nth.call(null,vec__11711,5,null);var seconds = cljs.core.nth.call(null,vec__11711,6,null);var fraction = cljs.core.nth.call(null,vec__11711,7,null);var offset_sign = cljs.core.nth.call(null,vec__11711,8,null);var offset_hours = cljs.core.nth.call(null,vec__11711,9,null);var offset_minutes = cljs.core.nth.call(null,vec__11711,10,null);var v = vec__11711;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__2963__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__2963__auto__))
{return or__2963__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__2963__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__2963__auto__))
{return or__2963__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__2963__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__2963__auto__))
{return or__2963__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__2963__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__2963__auto__))
{return or__2963__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__2963__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__2963__auto__))
{return or__2963__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__2963__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__2963__auto__))
{return or__2963__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__2963__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__2963__auto__))
{return or__2963__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__2963__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__2963__auto__))
{return or__2963__auto__;
} else
{return 0;
}
...
{var vec__11713 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__11713,0,null);var months = cljs.core.nth.call(null,vec__11713,1,null);var days = cljs.core.nth.call(null,vec__11713,2,null);var hours = cljs.core.nth.call(null,vec__11713,3,null);var minutes = cljs.core.nth.call(null,vec__11713,4,null);var seconds = cljs.core.nth.call(null,vec__11713,5,null);var ms = cljs.core.nth.call(null,vec__11713,6,null);var offset = cljs.core.nth.call(null,vec__11713,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
