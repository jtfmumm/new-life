...
{{
var G__11714 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11714;
continue;
}
} else
...
{var pred__11718 = cljs.core._EQ_;var expr__11719 = limit;if(pred__11718.call(null,1,expr__11719))
{return cljs.core.vector.call(null,s);
} else
{if(pred__11718.call(null,2,expr__11719))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__11721 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11722 = (limit__$1 - 1);
var G__11723 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11721;
limit__$1 = G__11722;
parts = G__11723;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___11725 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___11725))
{var replacement_11726 = temp__4090__auto___11725;buffer.append([cljs.core.str(replacement_11726)].join(''));
} else
{buffer.append(ch);
}
{
var G__11727 = (index + 1);
index = G__11727;
continue;
}
}
