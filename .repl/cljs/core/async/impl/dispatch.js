...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_10358 = 0;while(true){
var m_10359 = cljs.core.async.impl.dispatch.tasks.pop();if((m_10359 == null))
{} else
{m_10359.call(null);
if((count_10358 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__10360 = (count_10358 + 1);
count_10358 = G__10360;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__2954__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__2954__auto__)
