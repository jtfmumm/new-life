...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t10364 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t10364');

/**
* @constructor
*/
cljs.core.async.impl.channels.t10364 = (function (val,box,meta10365){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t10364.cljs$lang$type = true;
cljs.core.async.impl.channels.t10364.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t10364";
cljs.core.async.impl.channels.t10364.cljs$lang$ctorPrWriter = (function (this__3499__auto__,writer__3500__auto__,opt__3501__auto__){return cljs.core._write.call(null,writer__3500__auto__,"cljs.core.async.impl.channels/t10364");
});
cljs.core.async.impl.channels.t10364.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t10364.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_10366){var self__ = this;
var _10366__$1 = this;return self__.meta10365;
});
cljs.core.async.impl.channels.t10364.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_10366,meta10365__$1){var self__ = this;
var _10366__$1 = this;return (new cljs.core.async.impl.channels.t10364(self__.val,self__.box,meta10365__$1));
});
cljs.core.async.impl.channels.__GT_t10364 = (function __GT_t10364(val__$1,box__$1,meta10365){return (new cljs.core.async.impl.channels.t10364(val__$1,box__$1,meta10365));
});
}
return (new cljs.core.async.impl.channels.t10364(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3502__auto__,writer__3503__auto__,opts__3504__auto__){return cljs.core._write.call(null,writer__3503__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3499__auto__,writer__3500__auto__,opt__3501__auto__){return cljs.core._write.call(null,writer__3500__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_10367 = self__.takes.pop();if((taker_10367 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_10367))
{var take_cb_10368 = cljs.core.async.impl.protocols.commit.call(null,taker_10367);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_10368,taker_10367){
return (function (){return take_cb_10368.call(null,null);
});})(take_cb_10368,taker_10367))
);
} else
{}
{
