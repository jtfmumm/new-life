...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3499__auto__,writer__3500__auto__,opt__3501__auto__){return cljs.core._write.call(null,writer__3500__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_10335 = 0;while(true){
if((i_10335 < arr.length))
{(arr[i_10335] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3499__auto__,writer__3500__auto__,opt__3501__auto__){return cljs.core._write.call(null,writer__3500__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_10342 = (self__.level + 1);while(true){
if((i_10342 <= (new_level + 1)))
{(update[i_10342] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_10344 = 0;while(true){
if((i_10344 <= self__.level))
{var links_10345 = (update[i_10344]).forward;if(((links_10345[i_10344]) === x__$1))
{(links_10345[i_10344] = (x__$1.forward[i_10344]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__2963__auto__ = (cljs.core.truth_((function (){var and__2954__auto__ = me;if(cljs.core.truth_(and__2954__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__2954__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__2963__auto__))
